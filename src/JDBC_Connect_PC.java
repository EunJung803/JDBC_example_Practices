...
public class JDBC_Connect_PC {
	...
	public void pcSearch(String modelnumber) throws SQLException{ //모델 번호로 조회 
	      //모델에 대한 정보 저장할 변수
	      String model = "없음";
	      String speed = "0";
	      String ram = "0";
	      ...
	      catch(SQLException e) {JOptionPane.showMessageDialog(null, "김은정님, 입력한 모델명은 존재하지 않기 때문에 구매할 수 없습니다.", "메세지", JOptionPane.INFORMATION_MESSAGE);}
	      catch(Exception e) {
	         //JOptionPane.showMessageDialog(null, "노나현님, 입력한 모델명은 존재하지 않기 때문에 구매할 수 없습니다.", "메세지", JOptionPane.INFORMATION_MESSAGE);
	      }finally {
	         try {
